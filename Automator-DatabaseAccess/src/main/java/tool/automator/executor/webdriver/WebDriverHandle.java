...
public class WebDriverHandle {
	...
	private UIActionTypeConst getActionType(ElementModelIf element) {
		...
		if (elementUIType.equals(UIElementTypesConst.BUTTON) || elementUIType.equals(UIElementTypesConst.LINK)
				|| elementUIType.equals(UIElementTypesConst.RADIOBUTTON) || elementUIType.equals(UIElementTypesConst.CHECKBOX))
