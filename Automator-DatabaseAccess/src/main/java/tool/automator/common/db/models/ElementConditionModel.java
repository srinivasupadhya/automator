...
public class ElementConditionModel implements Serializable, ConditionIf {
	...
	private int elementRestrictionId;
	...
	// constructor
	public ElementConditionModel() {
		super();
	}

	public ElementConditionModel(int elementRestrictionId, int pageId, int elementId, int elementValueId) {
		super();
	...
	public int getElementRestrictionId() {
		return elementRestrictionId;
	}

	public void setElementRestrictionId(int elementRestrictionId) {
		this.elementRestrictionId = elementRestrictionId;
	}
	...
	public String toString() {
		return id + " " + elementRestrictionId + " " + pageId + " " + elementId + " " + elementValueId;
	}
}
