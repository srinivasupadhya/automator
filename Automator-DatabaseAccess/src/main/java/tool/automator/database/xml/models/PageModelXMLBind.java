...
public class PageModelXMLBind implements UIPageModelIf {
	...
	public PageModelXMLBind(Long id, String pageName, Long projectId, boolean startPage, int waitTime, String pageGetURL, String pageIdentifier, String pageIdentifierGetType,
	...
	public PageModelXMLBind(UIPageDTO page) {
		this.id = page.getId();
